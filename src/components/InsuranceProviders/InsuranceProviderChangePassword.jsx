...
const InsuranceProviderChangePassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:1313/api/mic/insuranceProvider/insuranceProviderChangePassword', { ...passwordData, insuranceProviderId }, {
                headers: {
...
export default InsuranceProviderChangePassword;
