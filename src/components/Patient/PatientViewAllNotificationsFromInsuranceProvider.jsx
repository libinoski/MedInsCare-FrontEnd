...
const PatientViewAllNotificationsFromInsuranceProvider = () => {
        ...
        const fetchNotifications = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:1313/api/mic/patient/viewAllNotifications',
                    { patientId },
                    {
                        headers: {
                            token
    ...
    const handleViewNotification = (notificationId) => {
        ...
        navigate('/PatientViewOneNotification'); // Navigate to the single notification detail page
    };
...
export default PatientViewAllNotificationsFromInsuranceProvider;
