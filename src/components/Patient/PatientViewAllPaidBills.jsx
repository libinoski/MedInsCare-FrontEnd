...
const PatientViewAllPaidBills = () => {
        ...
        const fetchBills = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:1313/api/mic/patient/viewAllPaidBills',
                    { patientId },
                    {
                        headers: {
                            token
    ...
    const handleViewBill = (billId) => {
        ...
        navigate(`/patientViewOnePaidBill`);
    };
...
export default PatientViewAllPaidBills;
