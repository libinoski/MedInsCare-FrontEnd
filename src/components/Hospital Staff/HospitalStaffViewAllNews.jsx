...
const HospitalStaffViewAllNews = () => {
        ...
        const fetchAllNews = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:1313/api/mic/hospitalStaff/hospitalStaffViewAllHospitalNews',
                    { hospitalStaffId },
                    {
                        headers: {
                            token
                ...
                if (error.response) {
                    ...
                    switch (status) {
                        ...
                        case 403:
                            ...
                            break;
                        case 422:
                            alert(data.error || 'Hospital staff not found or hospital not found or inactive.');
                            break;
                        case 500:
    ...
    const handleViewNews = (hospitalNewsId) => {
        ...
        navigate('/hospitalStaffViewOneNews');
    };
...
export default HospitalStaffViewAllNews;
