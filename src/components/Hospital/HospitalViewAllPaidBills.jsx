...
const HospitalViewAllPaidBills = () => {
        ...
        const fetchBills = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:1313/api/mic/hospital/viewAllPaidBills',
                    { hospitalId },
                    {
                        headers: {
                            token
    ...
    const handleViewBill = (billId) => {
        ...
        navigate(`/hospitalViewOnePaidBill`);
    };
...
export default HospitalViewAllPaidBills;
